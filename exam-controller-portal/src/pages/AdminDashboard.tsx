          ...
          <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-gray-50/50">
            ...
            <div className="flex bg-gray-200 p-1 rounded-xl">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold uppercase tracking-wider transition-all ${
                  activeTab === 'teachers' ? 'bg-white text-purple-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                Teachers
              </button>
            ...
            <div className="flex items-center gap-3">
              ...
              <label className={`cursor-pointer flex items-center gap-2 px-4 py-2.5 rounded-xl text-white font-bold text-sm uppercase tracking-wider shadow-md transition-transform hover:scale-105 ${
                activeTab === 'students' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-purple-600 hover:bg-purple-700'
              }`}>
                <Upload size={18} />
